...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.writer = vision.VideoFileWriter('basketball_forground_blob_kalman.avi');
...
% displays the frame and the mask in their respective video players. 
    ...
    function displayTrackingResults(nextId)
...
%                 print(gcf,'-djpeg' ,['matlabMOT_ggbeecs',num2str(nextId),'.jpeg'],'-r400')
