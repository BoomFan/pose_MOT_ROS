...
function Kalman_tracker_with_2dpose_estimation_ROS_neck_only_with_path()
...
%             pedes_data=joint_data{j*3+1};
            ...
            %%%% I only need the position of neck here %%%%
            %%%% And the box size is always 300X300 %%%%
%             xpixels = [];
%             for k=1:18
...
%             ymax_pixel=max(ypixels);
            bboxes=[bboxes;pedes_data(4)-neck_box_lenth/2,pedes_data(5)-neck_box_lenth/2,neck_box_lenth,neck_box_lenth];
    ...
    %     {14, "REye"}, {15, "LEye"}, {16, "REar"}, {17, "LEar"}, {18, "Bkg"}},
            centroids = [centroids;pedes_data(4),pedes_data(5);];
