...
function Kalman_tracker_with_2dpose_estimation()
...
pathname = 'E:\DanielBu\资料\硕士\EECS442 Mechine Vision机器视觉\project\Tracking\pose_MOT\labtest_2dpose\2dpose_str\';
pathname = 'E:\DanielBu\资料\硕士\EECS442 Mechine Vision机器视觉\project\Tracking\pose_MOT\lab_2d_pose\2dpose_str\';
foldername = dir(pathname);% 用于得出所有子文件夹的名字
...
% while piccont<55    
    ...
    num_of_people = length(joint_data)/3;
    centroids = [];
    bboxes = [];
    scores = [];
